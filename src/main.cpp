...
{
    std::cerr << "attn_server [options] <command> [<argument> ...]\n"
              << desc << std::endl
              << "Commands: \n"
#if 0
...
main(int argc, char** argv)
{
    ...
    general.add_options()("help,h", "Display this message.")(
        ...
        "request",
        po::value<std::string>(),
        "Execute provided request and outputs json result")(
    ...
    try
    {
        ...
        if (vm.count("request"))
        {
            // ex: --request "{\"request\": { \"door_account\":
            // \"rEEw6AmPHD28M5AHyrzFSVoLA3oANcmYas\", \"tx_hash\":
            // \"D638208ADBD04CBB10DE7B645D3AB4BA31489379411A3A347151702B6401AA78\"}
            // }"

            // ex:  --request "{\"request\": { \"dst_door\":
            // \"rEEw6AmPHD28M5AHyrzFSVoLA3oANcmYas\", \"sidechain\":
            // {\"src_chain_door\" : \"rEEw6AmPHD28M5AHyrzFSVoLA3oANcmYas\",
            // \"src_chain_issue\": \"XRP\", \"dst_chain_door\" :
            // \"rEEw6AmPHD28M5AHyrzFSVoLA3oANcmYas\", \"dst_chain_issue\":
            // \"XRP\"}, \"amount\":  { \"value\": \"13.1\", \"currency\":
            // \"FOO\", \"issuer\": \"rf1BiGeXwwQoi8Z2ueFYTEXSwuJYfV2Jpn\" },
